...
class _AdminPanelScreenState extends State<AdminPanelScreen> {
  ...
  Future<void> _saveMessages() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('admin_messages', jsonEncode(_messages));
  }
  ...
  Future<void> _loadUsers() async {
    ...
    String? individualGrade = prefs.getString('grade');
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Support Messages (${_messages.length})',
  ...
  void _showAddUserDialog(String userType) {
    ...
    String? selectedGrade = userType == 'Student' ? 'Grade 4' : null;
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (userType == 'Student') {
                          newUser['grade'] = selectedGrade ?? 'Grade 4';
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            if (user['grade'] != null && user['section'] != null)
              Text(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          if (_selectedIndex == 3) // Messages tab
            IconButton(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          ...
          // Reload messages when Messages tab is selected
          if (index == 3) {
            _loadMessages();
          }
        },
